...
import { User, UserStatus } from '../../types/usuario'; // Caminho relativo
...
type UsuariosPageProps = {
  usuarios: User[]; // Recebe a lista de usuários
};

export function UsuariosPageClient({ usuarios }: UsuariosPageProps) {
  ...
  return (
    <>
      ...
      >
        <NovoUsuarioForm onClose={() => setIsModalOpen(false)} />
      </Modal>
      ...
      <div className={styles.mainContentGrid}>
        ...
        <div className={styles.actionButton}>
          <div className="action-button">
            <button id="novo-usuario" onClick={() => setIsModalOpen(true)}>
              Novo Usuário
            </button>
          </div>
        </div>
